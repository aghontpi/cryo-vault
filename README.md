...
## Features
- **Built from scratch**: Minimal dependencies, single-file architecture.
- **Cross-platform**: Compiles to native binaries (Mac, Linux, Windows).
- **High Compression**: Uses `zstd` (preset 19) for maximum storage efficiency.
...
## Cons
- Only supports text conversations.
